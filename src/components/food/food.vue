      ...
      <div class="food-content">
          ...
          <div class="content">
            ...
            <div class="cartcontrol-wrapper">
              <!--引用到加减按钮组件，需要显式监听组件里面派发的事件“addToCart”-->
              <cartcontrol :food="food" @addToCart="drop"></cartcontrol>
            </div>
          ...
          <div class="rating">
            ...
            <!--:select-type传递数据到组件必须使用冒号：加破折号-相连才能正确传递，被传递的组件里面props定义了selectType，破折号自动转换为驼峰式变量-->
           <!-- 当一个子组件修改带有 .sync 修饰符的 prop 时，设置的值就会反向映射(reflect)到父组件中，父组件的值就会自动改变了！-->
            <ratingselect  @refresh="refreshFoodContentData"  :select-type.sync="selectType" :only-content.sync="onlyContent" :desc="desc" :ratings="food.ratings"></ratingselect>
